<?php include './php/loadProduct.php';?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Complete Responsive Pet Food</title>
...
<body>
            ...
            if(isset ($_POST['login'])){
                ...
                if($data != null){
                    if($data['password'] == $password){
                        ...
                        echo '<script>alert("Wrong Password , try Plz try again")</script>';
                    }
                }

                else{
                    echo '<script>alert("Email not registered ..! plz sign up !")</script>';
                }
        ...
        {   ?>
            <div class="box">
                ...
                <div class="content">
                    ...
                    <div class="amount"> <?php echo $value['price']; ?> $</div>
                </div>
            </div>
            <?php   
        }
    ...
    <section class="contact" id="contact">
        ...
        <form action="./php/contact.php" method ="post">
            ...
            <input type="tumber" placeholder="your number" name="number" class="box">
            <textarea name="" placeholder="your message" name="messages" id="" cols="30" rows="10"></textarea>
    ...
    <section class="footer">
        ...
        <div class="credit"> created by <span> Clearcode Technologis </span> | all rights reserved! </div>
